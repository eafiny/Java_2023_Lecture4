...
class LambdaDemo{
    public static void main(String[] args) {
        ...
        System.out.println("Pасчет: " + doSomethingWithLambda(x -> (double) x/2));
    ...
    public static Double doSomethingWithLambda(NewInterface<Integer, Double> nf){
        return nf.calculate(7);
